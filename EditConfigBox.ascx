...
<div class="bodyContentStyle">
	...
	<div class="configSectionStyle">
		...
		<table cellspacing="0" cellpadding="2" border="0">
			<tr>
				<td class="configLabelColumnStyle" nowrap>
	...
	<div class="configSectionStyle">
		...
		<table cellspacing="0" cellpadding="2" border="0">
			<tr>
				<td class="configLabelColumnStyle" style="HEIGHT: 21px" nowrap>
			...
			<tr>
				<td colspan="2" class="configLabelColumnStyle" style="HEIGHT: 21px" nowrap>
			...
			<tr>
				<td class="configLabelColumnStyle" colspan="2">
					<fieldset>
						...
						<table>
							<tr>
								<td class="configLabelColumnStyle" style="HEIGHT: 21px" nowrap colspan="2">
	...
	<div class="configSectionStyle">
		...
		<table cellspacing="0" cellpadding="2" border="0">
			<tr>
				<td class="configLabelColumnStyle" nowrap>
					<asp:Label ID="labelTheme" runat="server" Text='<%# resmgr.GetString("text_config_default_theme") %>' CssClass="configLabelStyle">
					</asp:Label></td>
				<td colspan="2">
					<asp:DropDownList ID="listThemes" AccessKey="H" runat="server" CssClass="configControlStyle"></asp:DropDownList></td>
			</tr>
			<tr>
				<td class="configLabelColumnStyle" nowrap>
			...
			<tr>
				...
				<td class="configLabelColumnStyle" nowrap colspan="2">
	...
	<div class="configSectionStyle">
		...
		<table cellspacing="0" cellpadding="2" border="0">
			...
			<tr>
				...
				<td class="configLabelColumnStyle" nowrap colspan="3">
			...
			<tr>
				<td class="configLabelColumnStyle" nowrap colspan="4">
	...
	<div class="configSectionStyle">
		...
		<table cellspacing="0" cellpadding="2" border="0">
			<tr>
				<td class="configLabelColumnStyle" lang="20%" nowrap>
				</td>
				<td>
